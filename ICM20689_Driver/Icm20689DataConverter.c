...
{
    quatProd_q30[0] = inv_icm20689_convert_mult_q30_fxp(quat1_q30[0], quat2_q30[0]) - inv_icm20689_convert_mult_q30_fxp(quat1_q30[1], quat2_q30[1]) -
               inv_icm20689_convert_mult_q30_fxp(quat1_q30[2], quat2_q30[2]) - inv_icm20689_convert_mult_q30_fxp(quat1_q30[3], quat2_q30[3]);

    quatProd_q30[1] = inv_icm20689_convert_mult_q30_fxp(quat1_q30[0], quat2_q30[1]) + inv_icm20689_convert_mult_q30_fxp(quat1_q30[1], quat2_q30[0]) +
               inv_icm20689_convert_mult_q30_fxp(quat1_q30[2], quat2_q30[3]) - inv_icm20689_convert_mult_q30_fxp(quat1_q30[3], quat2_q30[2]);

    quatProd_q30[2] = inv_icm20689_convert_mult_q30_fxp(quat1_q30[0], quat2_q30[2]) - inv_icm20689_convert_mult_q30_fxp(quat1_q30[1], quat2_q30[3]) +
               inv_icm20689_convert_mult_q30_fxp(quat1_q30[2], quat2_q30[0]) + inv_icm20689_convert_mult_q30_fxp(quat1_q30[3], quat2_q30[1]);

    quatProd_q30[3] = inv_icm20689_convert_mult_q30_fxp(quat1_q30[0], quat2_q30[3]) + inv_icm20689_convert_mult_q30_fxp(quat1_q30[1], quat2_q30[2]) -
               inv_icm20689_convert_mult_q30_fxp(quat1_q30[2], quat2_q30[1]) + inv_icm20689_convert_mult_q30_fxp(quat1_q30[3], quat2_q30[0]);
}
...
void inv_icm20689_q_mult_q_qi(const long *q1, const long *q2, long *qProd)
{
    qProd[0] = inv_icm20689_convert_mult_q30_fxp(q1[0], q2[0]) + inv_icm20689_convert_mult_q30_fxp(q1[1], q2[1]) +
               inv_icm20689_convert_mult_q30_fxp(q1[2], q2[2]) + inv_icm20689_convert_mult_q30_fxp(q1[3], q2[3]);

    qProd[1] = -inv_icm20689_convert_mult_q30_fxp(q1[0], q2[1]) + inv_icm20689_convert_mult_q30_fxp(q1[1], q2[0]) -
               inv_icm20689_convert_mult_q30_fxp(q1[2], q2[3]) + inv_icm20689_convert_mult_q30_fxp(q1[3], q2[2]);

    qProd[2] = -inv_icm20689_convert_mult_q30_fxp(q1[0], q2[2]) + inv_icm20689_convert_mult_q30_fxp(q1[1], q2[3]) +
               inv_icm20689_convert_mult_q30_fxp(q1[2], q2[0]) - inv_icm20689_convert_mult_q30_fxp(q1[3], q2[1]);

    qProd[3] = -inv_icm20689_convert_mult_q30_fxp(q1[0], q2[3]) - inv_icm20689_convert_mult_q30_fxp(q1[1], q2[2]) +
               inv_icm20689_convert_mult_q30_fxp(q1[2], q2[1]) + inv_icm20689_convert_mult_q30_fxp(q1[3], q2[0]);
}

void inv_icm20689_convert_quat_rotate_fxp(const long *quat_q30, const long *in, long *out)
{
...
*/
void inv_icm20689_set_chip_to_body(struct inv_icm20689 * s, long *quat)
{
...
*/
void inv_icm20689_convert_rotation_vector(struct inv_icm20689 * s, const long *quat, float *values)
{
    long quat4[4];
    long quat_body_to_world[4];

    inv_icm20689_convert_compute_scalar_part_fxp(quat, quat4);
    inv_icm20689_q_mult_q_qi(quat4, s->s_quat_chip_to_body, quat_body_to_world);
...
*/
void inv_icm20689_convert_rotation_vector_2(struct inv_icm20689 * s, const long *quat, long *quat4_world)
{
    long quat4[4];
    long quat_body_to_world[4];
...
*/
void inv_icm20689_convert_rotation_vector_3(const long *quat4_world, float *values)
{
    if (quat4_world[0] >= 0) {
...
static void inv_rotation_to_quaternion(float Rcb[9], long Qcb_fp[4]) {	
	float q[4]; 
	inv_icm20689_convert_matrix_to_quat_flt(Rcb, q); 
	INVN_CONVERT_FLT_TO_FXP(q, Qcb_fp, 4, 30); 
}

void inv_icm20689_set_chip_to_body_axis_quaternion(struct inv_icm20689 * s, signed char *accel_gyro_matrix, float angle)
{
    int i;
    float rot[9];
    long qcb[4],q_all[4];
    ...
    // inv_icm20689_convert_matrix_to_quat_fxp(rot, qcb);
    ...
    inv_icm20689_set_chip_to_body(s, q_all);
}

void inv_icm20689_convert_dmp3_to_body(struct inv_icm20689 * s, const long *vec3, float scale, float *values)
{
    long out[3];
    inv_icm20689_convert_quat_rotate_fxp(s->s_quat_chip_to_body, vec3, out);
...
unsigned char *inv_icm20689_int32_to_little8(long x, unsigned char *little8)
{
...
float inv_icm20689_convert_deg_to_rad(float deg_val)
{
	float rad_val;
...
int inv_icm20689_convert_compute_scalar_part_fxp(const long * inQuat_q30, long* outQuat_q30)
{
    long scalarPart = 0;

    scalarPart = inv_icm20689_convert_fast_sqrt_fxp((1L<<30) - inv_icm20689_convert_mult_q30_fxp(inQuat_q30[0], inQuat_q30[0])
                                        - inv_icm20689_convert_mult_q30_fxp(inQuat_q30[1], inQuat_q30[1])
                                        - inv_icm20689_convert_mult_q30_fxp(inQuat_q30[2], inQuat_q30[2]) );
...
long inv_icm20689_convert_fast_sqrt_fxp(long x0_q30)
{
	...
	nr_iters = inv_icm20689_convert_test_limits_and_scale_fxp(&x0_q30, &pow2);
	...
	cc = x0_q30 - (1L<<30);
	xx = x0_q30 - (inv_icm20689_convert_mult_q30_fxp(x0_q30, cc)>>1);
 	if ( nr_iters>=2 ) {
		// Sqrt second NR iteration
		// cc = cc*cc*(cc-3)/4; = cc*cc*(cc/2 - 3/2)/2;
		// cc = ( cc*cc*((cc>>1) - onePt5) ) >> 1
		cc = inv_icm20689_convert_mult_q30_fxp( cc, inv_icm20689_convert_mult_q30_fxp(cc, (cc>>1) - one_pt5) ) >> 1;
		xx = xx - (inv_icm20689_convert_mult_q30_fxp(xx, cc)>>1);
		if ( nr_iters==3 ) {
	...
	if (sq2scale)
		xx = inv_icm20689_convert_mult_q30_fxp(xx,oneoversqrt2);
	// Scale the number with the half of the power of 2 scaling
	if (pow2>0)
		xx = (xx >> (pow2>>1)); 
	else if (pow2 == -1)
		xx = inv_icm20689_convert_mult_q30_fxp(xx,sqrt2);
	return xx;
}
...
int inv_icm20689_convert_test_limits_and_scale_fxp(long *x0_q30, int *pow)
{
	...
	if (*x0_q30 > upperlimit) {
		...
		*pow=inv_icm20689_convert_get_highest_bit_position((uint32_t*)x0_q30);
		if (*x0_q30 >= upperlimit) {
...
* \ingroup binary
**/
int16_t inv_icm20689_convert_get_highest_bit_position(uint32_t *value)
{
    int16_t position;
    position = 0;
    if (*value == 0) return 0;
...
void inv_icm20689_convert_matrix_to_quat_fxp(long *Rcb_q30, long *Qcb_q30)
{
         ...
         //Qcb[2] = sqrt(Qcb[2]);
         //Qcb[3] = sqrt(Qcb[3]);
         Qcb_q30[0] = inv_icm20689_convert_sqrt_q30_fxp(Qcb_q30[0]);
         Qcb_q30[1] = inv_icm20689_convert_sqrt_q30_fxp(Qcb_q30[1]);
         Qcb_q30[2] = inv_icm20689_convert_sqrt_q30_fxp(Qcb_q30[2]);
         Qcb_q30[3] = inv_icm20689_convert_sqrt_q30_fxp(Qcb_q30[3]);

         if(Qcb_q30[0] >= Qcb_q30[1] && Qcb_q30[0] >= Qcb_q30[2] && Qcb_q30[0] >= Qcb_q30[3]) //Qcb[0] is max
         {
                tmp = inv_icm20689_convert_inverse_q30_fxp(Qcb_q30[0], &pow2);
                shift = 30 - pow2 + 1;
         ...
         {
                tmp = inv_icm20689_convert_inverse_q30_fxp(Qcb_q30[1], &pow2);
                shift = 30 - pow2 + 1;
         ...
         {
                tmp = inv_icm20689_convert_inverse_q30_fxp(Qcb_q30[2], &pow2);
                shift = 30 - pow2 + 1;
         ...
         {
                tmp = inv_icm20689_convert_inverse_q30_fxp(Qcb_q30[3], &pow2);
                shift = 30 - pow2 + 1;
        ...
        // Normalize
        Qcb_q30[0] = inv_icm20689_convert_mult_q30_fxp(temp[0], Qcb_q30[0]);
        Qcb_q30[1] = inv_icm20689_convert_mult_q30_fxp(temp[0], Qcb_q30[1]);
        Qcb_q30[2] = inv_icm20689_convert_mult_q30_fxp(temp[0], Qcb_q30[2]);
        Qcb_q30[3] = inv_icm20689_convert_mult_q30_fxp(temp[0], Qcb_q30[3]);
}

long inv_icm20689_convert_sqrt_q30_fxp(long x_q30)
{
    long sqrtx;
    int pow2;
    ...
    sqrtx = inv_icm20689_convert_inv_sqrt_q30_fxp(x_q30, &pow2); // invsqrtx

    sqrtx = inv_icm20689_convert_mult_q30_fxp(x_q30, sqrtx);
...
long inv_icm20689_convert_inv_sqrt_q30_fxp(long x_q30, int *pow2)
{
...
upscale:
    ...
    x0_2 = xx >>1;
    xx = oneandhalf - x0_2;
    xx = inv_icm20689_convert_mult_q30_fxp( xx, ( oneandhalf - inv_icm20689_convert_mult_q30_fxp(x0_2, inv_icm20689_convert_mult_q30_fxp(xx,xx) ) ) );
    xx = inv_icm20689_convert_mult_q30_fxp( xx, ( oneandhalf - inv_icm20689_convert_mult_q30_fxp(x0_2, inv_icm20689_convert_mult_q30_fxp(xx,xx) ) ) );

    if (*pow2 & 1) { // This checks if the number is even or odd.
        *pow2 = (*pow2>>1) + 1; // Account for sqrt(2) in denominator
        invsqrtx = (inv_icm20689_convert_mult_q30_fxp(xx,oneoversqrt2));
    }
    else {
        *pow2 = *pow2>>1;
        invsqrtx =  xx;
...
long inv_icm20689_convert_inverse_q30_fxp(long x_q30, int *pow2)
{
    long y;
    int negx;
    ...
    y = inv_icm20689_convert_inv_sqrt_q30_fxp (x_q30, pow2); // sqrt(y)
    if (y > 1518500249L) // y > int32(sqrt(2) -1 : Largest number that won't overflow q30 multiplication of y*y
        y = INT32_MAX;
    else
        y = inv_icm20689_convert_mult_q30_fxp(y, y);
...
void inv_icm20689_convert_matrix_to_quat_flt(float *R, float *q)
{
...
long inv_icm20689_convert_mult_qfix_fxp(long a, long b, unsigned char qfix)
{
    long long temp;
    long result;
    temp = (long long)a * b;
...
void inv_icm20689_convert_quat_to_col_major_matrix_fxp(const long *quat_q30, long *rot_q30)
{
...
long inv_icm20689_math_atan2_q15_fxp(long y_q15, long x_q15)
{
...
uint8_t *inv_icm20689_convert_int16_to_big8(int16_t x, uint8_t *big8)
{
...
uint8_t *inv_icm20689_convert_int32_to_big8(int32_t x, uint8_t *big8)
{
...
int32_t inv_icm20689_convert_big8_to_int32(const uint8_t *big8)
{
    int32_t x;
