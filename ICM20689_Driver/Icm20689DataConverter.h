...
* ________________________________________________________________________________________________________
*/
/** @defgroup icm20689_data_converter data_converter
	@ingroup  SmartSensor_driver
	@{
*/	
#ifndef INV_icm20689_DATA_CONVERTER_H__
#define INV_icm20689_DATA_CONVERTER_H__
...
*             1.0 scaled to 2^30.
*/
void INV_EXPORT inv_icm20689_q_mult_q_qi(const long *q1, const long *q2, long *qProd);

/** @brief Sets the transformation used for chip to body frame
* @param[in] quat 	the quaternion used for the transformation
*/	
void INV_EXPORT inv_icm20689_set_chip_to_body(struct inv_icm20689 * s, long *quat);
...
*/
void INV_EXPORT inv_icm20689_convert_rotation_vector(struct inv_icm20689 * s, const long *quat, float *values);
...
*/
void INV_EXPORT inv_icm20689_convert_rotation_vector_2(struct inv_icm20689 * s, const long *quat, long *quat4_world);
...
*/
void INV_EXPORT inv_icm20689_convert_rotation_vector_3(const long *quat4_world, float *values);
...
* @param[out] values in Android format
*/
void INV_EXPORT inv_icm20689_convert_dmp3_to_body(struct inv_icm20689 * s, const long *vec3, float scale, float *values);
...
*/
void INV_EXPORT inv_icm20689_set_chip_to_body_axis_quaternion(struct inv_icm20689 * s,signed char *accel_gyro_matrix, float angle);
...
*/	
unsigned char INV_EXPORT *inv_icm20689_int32_to_little8(long x, unsigned char *little8);

/** @brief Converts degree angle to radian
* @param[in] deg_val 		the angle in degree
* @return 					the angle in radian
*/	
float INV_EXPORT inv_icm20689_convert_deg_to_rad(float deg_val);
 ...
 * @return ((long long)a*b)>>30 
 \ingroup ScalarFxp
*/
long INV_EXPORT inv_icm20689_convert_mult_q30_fxp(long a_q30, long b_q30);
...
int INV_EXPORT inv_icm20689_convert_compute_scalar_part_fxp(const long * inQuat_q30, long* outQuat_q30);
...
\ingroup ScalarFxp
**/
long INV_EXPORT inv_icm20689_convert_fast_sqrt_fxp(long x0_q30);
...
\ingroup ScalarFxp
*/
int INV_EXPORT inv_icm20689_convert_test_limits_and_scale_fxp(long *x0_q30, int *pow);
...
* \ingroup binary
**/
int16_t INV_EXPORT inv_icm20689_convert_get_highest_bit_position(uint32_t *value);
 ...
 * \ingroup QuaternionFxp
 */
void INV_EXPORT inv_icm20689_convert_matrix_to_quat_fxp(long *Rcb_q30, long *Qcb_q30);
...
\ingroup ScalarFxp
**/
long INV_EXPORT inv_icm20689_convert_sqrt_q30_fxp(long x_q30);
...
\ingroup ScalarFxp
*/
long INV_EXPORT inv_icm20689_convert_inv_sqrt_q30_fxp(long x_q30, int *pow2);
...
\ingroup ScalarFxp
**/
long INV_EXPORT inv_icm20689_convert_inverse_q30_fxp(long x_q30, int *pow2);
...
void INV_EXPORT inv_icm20689_convert_matrix_to_quat_flt(float *R, float *q);
 ...
 * \warning Same function that invn_math_mult_qfix_fxp. 
 \ingroup ScalarFxp
*/
long INV_EXPORT inv_icm20689_convert_mult_qfix_fxp(long a, long b, unsigned char qfix);
 ...
 * \ingroup MatrixFxp
 */
void INV_EXPORT inv_icm20689_convert_quat_to_col_major_matrix_fxp(const long *quat_q30, long *rot_q30);
...
* \ingroup GeometryFxp
*/
long INV_EXPORT inv_icm20689_math_atan2_q15_fxp(long y_q15, long x_q15);
 ...
 * \ingroup binary
 */
uint8_t INV_EXPORT *inv_icm20689_convert_int16_to_big8(int16_t x, uint8_t *big8);
 ...
 * \ingroup binary
*/
uint8_t INV_EXPORT *inv_icm20689_convert_int32_to_big8(int32_t x, uint8_t *big8);
 ...
 * \ingroup binary
 */
int32_t INV_EXPORT inv_icm20689_convert_big8_to_int32(const uint8_t *big8);
 ...
 * \return void
 */
void INV_EXPORT inv_icm20689_convert_quat_rotate_fxp(const long *quat_q30, const long *in, long *out);
#ifdef __cplusplus
}
#endif
#endif	/* INV_icm20689_DATA_CONVERTER_H__ */
