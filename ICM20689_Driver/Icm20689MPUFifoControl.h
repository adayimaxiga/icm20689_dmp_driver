...
* ________________________________________________________________________________________________________
*/
/** @defgroup inv_icm20689_mpu_fifo_control inv_mpu_fifo_control
	@ingroup  SmartSensor_driver
	@{
*/	
#ifndef _INV_icm20689_MPU_FIFO_CONTROL_H_
#define _INV_icm20689_MPU_FIFO_CONTROL_H_
...
*/	
int INV_EXPORT inv_icm20689_identify_interrupt(struct inv_icm20689 * s, short *int_read);
...
*/
int inv_icm20689_dmp_reset_fifo(void);
...
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20689_dmp_process_fifo(struct inv_icm20689 * s, int *left_in_fifo, unsigned short *user_header, unsigned short *user_header2, long *time_stamp);

/** @brief Gets the accelerometer data 
* @param[out] acl[3]	the accelerometer data 
* @return 					0 on success, negative value on error.
*/		
int INV_EXPORT inv_icm20689_dmp_get_accel(long acl[3]);

/** @brief Gets the raw gyrometer data 
* @param[out] raw_gyro[3]	the raw gyrometer data 
* @return 						0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20689_dmp_get_raw_gyro(short raw_gyro[3]);

/** @brief Gets gyro bias
* @param[out] gyro_bias[3]	Gyro bias x,y,z
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20689_dmp_get_gyro_bias(long gyro_bias[3]);
...
* @return 			0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20689_fifo_swmirror(struct inv_icm20689 * s, int *left_in_fifo, unsigned short * total_sample_cnt, unsigned short * sample_cnt_array);
...
* @return 			0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20689_fifo_pop(struct inv_icm20689 * s, unsigned short *user_header, unsigned short *user_header2, int *left_in_fifo);

//int dmp_read_fifo(struct inv_icm20689 * s, unsigned char *data, uint_fast16_t len);

#ifdef __cplusplus
}
#endif
#endif /* _INV_icm20689_MPU_FIFO_CONTROL_H_ */
